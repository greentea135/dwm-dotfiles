...
static const char col_gray5[]       = "#00FF00";
...
/* tagging */
static const char *tags[] = { "あ", "か", "さ", "た", "な", "は", "ま", "や", "ら" };
...
static const char *scrotcmd[] = { "sh", "-c", "scrot \"$HOME/Pictures/scrot/%Y-%m-%d_%H-%M-%S.png\"", NULL };
